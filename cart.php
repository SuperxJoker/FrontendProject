    ...
    <div class="icon-menu">
      ...
      <li>
        ...
        if(isset($_SESSION['cart'])){
          ...
          echo "<span id=\"cart_count\"  style=\"color:yellowgreen;border-radius: 3rem;font-size:19px;font-weight:600;\">$count</span>";
        }
        else{
          echo "<span id=\"cart_count\"  style=\"color:yellowgreen;border-radius: 3rem;font-size:19px;font-weight:600;\">0</span>";
        }
